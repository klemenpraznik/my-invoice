            ...
            <div class="card card-custom">
                <div class="card-header">
                    ...
                    <div style="display: grid; align-items: center;">
                        <a href="category/create" class="btn btn-primary">Dodaj kategorijo</a>
                    </div>
                </div>

                <div class="card-body">
                    <table id="categories" class="hover table table-bordered dt-responsive nowrap" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col" data-priority="1">Ime</th>
    ...
    $(document).ready(function () {
        ...
        var table = $("#categories").DataTable({
            ajax: {
                ...
                url: "/api/user/{{auth()->user()->id}}/categories",
                dataSrc: ""
            },
            columns: [
                {
