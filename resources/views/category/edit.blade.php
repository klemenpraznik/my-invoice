...
<div class="row col-lg-12">
    <div class="card card-custom col-lg-12">
            <div class="card-header">
                <h3 class="card-title">
                    Urejanje kategorije - {{ $category->name }}
                </h3>
            </div>
            <form method="POST" action="/category/{{ $category-> id }}" encrypte="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-5">
                        ...
                        <textarea   id="description" 
                                    ...
                                    rows="4" autofocus>{{ old('description') ??  $category->description }}
                        </textarea>
