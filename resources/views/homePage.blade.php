...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('laurel/dist/css/style.css')}}">
...
<body class="is-boxed has-animations">
    <div class="body-wrap boxed-container">
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="#">
								<img alt="{{ config('app.name') }}" src="{{ asset('media/logos/my-logo.png') }}" width="120px"/>
                            </a>
                        </h1>
                    </div>
                </div>
        ...
        <main>
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Program za izdajanje računov</h1>
	                        <p class="hero-paragraph">rogram za obrtnike, podjetja in nevladne organizacije z zunanjim računovodstvom. Naša cilja sta preprost, a učinkovit program za podjetnike, ter dobra podpora.</p>
	                        <div class="hero-cta"><a class="button button-shadow" href="#description">O projektu</a><a class="button button-primary button-shadow" href="/home">Prijava v sistem</a></div>
						</div>
						<div class="hero-app">
							...
							<img class="device-mockup" src="{{ asset('laurel/dist/images/macbook-mockup.png')}}" alt="App preview" style="width: 550px !important">
            ...
            <section class="features section">
                <div class="container">
					<div class="features-inner section-inner has-bottom-divider">
						<h2 class="section-title mt-0">Prednosti</h2>
                        <div class="features-wrap">
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">Preglednost</h3>
                                    <p class="text-sm mb-0">Hiter pregled vašega poslovanja</p>
                                </div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">Prilagodljivost</h3>
                                    <p class="text-sm mb-0">Prilagodite izgled svoji organizaciji</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h3 class="feature-title mt-24">Preprostost</h3>
                                    <p class="text-sm mb-0">Intuitiven in moderen design, primeren tudi za delo na mobilnih napravah</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="media section">
                <div ID="description" class="container-sm">
                    <div class="media-inner section-inner">
                        <div class="media-header text-center">
                            <h2 class="section-title mt-0">Opis projekta</h2>
							<br>
                            <p class="section-paragraph mb-0">My Invoice je spletna aplikacija, ki je namenjena preprostemu izdelovanju računov. 
								Aplikacija poleg tega omogoča vodenje izdelkov/storitev in kategorij ter strank. 
								Aplikacija ima izdelan tudi API, preko katerega bi se dalo razviti tudi mobilno aplikacijo. Spletna aplikacija je sicer optimizirana za delovanje na mobilnih napravah.</p>
                        </div>
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    ...
                    <ul class="footer-links list-reset">
                        <li>
                            <a href="https://github.com/klemenpraznik" target="_blank">Klemen Praznik</a>
                        </li>
                    </ul>
                    <ul class="footer-social-links list-reset">
                        
                    </ul>
                    <div class="footer-copyright">&copy; 2021 - FRI - Spletne tehnologije</div>
                </div>
            </div>
        </footer>
    </div>
    ...
    <script src="{{ asset('laurel/dist/js/main.min.js')}}"></script>
</body>
</html>
