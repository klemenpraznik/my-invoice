		...
		<div class="navi navi-spacer-x-0 p-0">
			<div class="d-flex align-items-center mt-5">
				<div class="d-flex flex-column" style="width: 100%;">
					<div class="text-muted mt-1">Uporabnik:</div>
					<div class="navi mt-2">
						<a href="#" class="navi-item">
							<span class="navi-link p-0 pb-2">
								...
								<span class="navi-text text-muted text-hover-primary" style="width: 100%;">
									@auth 
										{{ Auth::user()->name }}
									@endauth
								</span>
					...
					<div class="navi mt-2">
						<a href="#" class="navi-item">
							<span class="navi-link p-0 pb-2">
								<span class="navi-icon mr-1">
									<span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Communication/Mail.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
